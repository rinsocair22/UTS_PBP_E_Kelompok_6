...
public class UpdatePackageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        packageIconIv = findViewById(R.id.packageIcon);
        btnBack = findViewById(R.id.backBtn);

        //get id of the package from intent

        packageID = getIntent().getStringExtra("packageID");

        fAuth=FirebaseAuth.getInstance();
        loadPackageDetails();//set on views
        ...
        packageIconIv.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void loadPackageDetails() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("package");
        reference.child(packageID)
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        //get data
                        String packageID = ""+snapshot.child("packageID").getValue();
                        String packageName = ""+snapshot.child("packageName").getValue();
                        String packagePrice = ""+snapshot.child("packagePrice").getValue();
                        String packageType = ""+snapshot.child("packageType").getValue();
                        String packageDescription = ""+snapshot.child("packageDescription").getValue();
                        String packageIcon = ""+snapshot.child("packageIcon").getValue();
                        String PgID = ""+snapshot.child("PgID").getValue();

                        //set data to view

                        etPackageName.setText(packageName);
                        etPackagePrice.setText(packagePrice);
                        etPackageDescription.setText(packageDescription);
                        etPackageType.setText(packageType);
    ...
    private void updatePackage() {
        ...
        if(image_uri==null){
            ...
            packageRef.child(packageID).updateChildren(hashMap)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                //update success
                                progressDialog.dismiss();
                                Toast.makeText(UpdatePackageActivity.this,"Updated", Toast.LENGTH_SHORT).show();
                            }
                        })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            //update failed
                            progressDialog.dismiss();
                            Toast.makeText(UpdatePackageActivity.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
            ...
            String filePathAndName = "package_images/"+""+packageID;//overide previous image using same id
            //uploaded image
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(resultCode== RESULT_OK){
            if(requestCode== IMAGE_PICK_GALLERY_CODE){
                ...
                //set image
                packageIconIv.setImageURI(image_uri);
            }
