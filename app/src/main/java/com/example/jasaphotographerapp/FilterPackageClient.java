...
public class FilterPackageClient extends Filter {


    private AdapterPackageClient adapter;
    private ArrayList<ModelPackage> filterList;

    public FilterPackageClient (AdapterPackageClient adapter, ArrayList<ModelPackage> filterList) {
