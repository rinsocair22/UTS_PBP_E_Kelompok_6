...
public class FilterBookingClient extends Filter {

    private AdapterBookingClient adapter;

    private ArrayList<ModelBooking> filterList;

    public FilterBookingClient(AdapterBookingClient adapter, ArrayList<ModelBooking> filterList){
