...
public class BookingPhotographerActivity extends AppCompatActivity {
    ...
    private AdapterBookingPhotographer adapterBookingPhotographer;
    private FirebaseAuth fAuth = FirebaseAuth.getInstance();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_booking_photographer);
            ...
            public void onClick(View v) {
                ...
                int day = calendar.get(Calendar.DAY_OF_MONTH);
                    ...
                    DatePickerDialog datePickerDialog = new DatePickerDialog(
                            BookingPhotographerActivity.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
        ...
        searchBookingEt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                try{
                        adapterBookingPhotographer.getFilter().filter(s);
                }
                catch(Exception e){
                    e.printStackTrace();
                }
        ...
        filterPackageBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(BookingPhotographerActivity.this);
    ...
    private void loadFilteredBooking(String selected) {
        ...
        bookingRef.orderByChild("pgID").equalTo(fAuth.getCurrentUser().getUid())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup adapter
                        adapterBookingPhotographer = new AdapterBookingPhotographer(BookingPhotographerActivity.this, bookingList);
                        //set adapter
                        bookingRv.setAdapter(adapterBookingPhotographer);
    ...
    private void loadFilteredBookingPackage(String selected) {
        ...
        packageRef.orderByChild("pgID").equalTo(fAuth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                bookingList.clear();
